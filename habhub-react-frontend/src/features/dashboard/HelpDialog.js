...
const useStyles = makeStyles((theme) => ({
  ...
  function getSteps() {
    return ['Select HAB Species', 'Select Data Layers', 'Select Timeframe', 'View and Save Data', 'Learn More'];
  }
...
export default function HelpDialog() {
  ...
  return (
    <div>
        <DialogTitle id="alert-dialog-title">{"Welcome to the WHOI HABHub!​"}</DialogTitle>
        <DialogContent>
