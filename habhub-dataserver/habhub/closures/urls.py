...
urlpatterns = [
    ...
    path('map-main/', views.ClosureMapClusterMainView.as_view(), name='closures_map_main'),
    ...
    path('maps/ajax/load-closures-data-events-by-area/<shellfish_area_id>/', views.ClosureDataEventAjaxGetByAreaView.as_view(), name='ajax_load_closure_data_events_by_area'),
    path('maps/ajax/load-closures-data-events-by-notice/<shellfish_area_id>/<notice_id>/', views.ClosureDataEventAjaxGetByNoticeView.as_view(), name='ajax_load_closure_data_events_by_notice'),
