...
def create_target_species(apps, schema_editor):
    ...
    TARGET_SPECIES_INITIAL = [
        ...
        'color_gradient': ["#fee5d9", "#fcae91", "#fb6a4a", "#e31a1c", "#a50f15"]
        },
        {
        ...
        'color_gradient': ["#eff3ff", "#bdd7e7", "#6baed6", "#1f78b4", "#08519c"]
        },
        {
        ...
        'color_gradient': ["#fafafa", "#eeeeee", "#bdbdbd", "#9e9e9e", "#616161"]
        },
        {
        'id': "Karenia",
        ...
        'color_gradient': ["#edf8e9", "#bae4b3", "#74c476", "#33a02c", "#006d2c"]
        },
        {
        'id': "Margalefidinium",
        ...
        'color_gradient': ["#fffde7", "#fff59d", "#fff176", "#ffeb3b", "#fdd835"]
        },
        {
        'id': "Pseudo-nitzschia",
        ...
        'color_gradient': ["#ede7f6", "#d1c4e9", "#9575cd", "#673ab7", "#311b92"]
        }
    ]
    ...
    for species in TARGET_SPECIES_INITIAL:
        species_obj, created = TargetSpecies.objects.get_or_create(
            ...
            defaults={
                ...
                'color_gradient': species['color_gradient']
            },
        )
