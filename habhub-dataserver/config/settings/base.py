...
)  # (starterkit/config/settings/base.py - 3 = starterkit/)
...
MIGRATION_MODULES = {"sites": "habhub.contrib.sites.migrations"}
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"anon": "100000/day", "user": "1000000/day"},
}
